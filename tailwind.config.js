...
export default {
    ...
    theme: {
        extend: {
            /*
             * Semantic color tokens ported from Postiz
             * (apps/frontend/tailwind.config.cjs + colors.scss).
             * Values are CSS custom properties defined in resources/css/app.css
             * so the light/dark palettes stay swappable via the `dark` class.
             */
            colors: {
